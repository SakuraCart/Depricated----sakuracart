...
// Address choose exisiting or add new (from address template)
/*
$('#' + type + '-address select[name=\'zone_id\']').load(url + country_id);

$('#' + type + '-address input[name=\"' + type + '"_address\']').live('change', function() {
	if (this.value == 'new') {
		$('#' + type + '-existing').hide();
		$('#' + type + '-new').show();
	} else {
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-account').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#payment-address #button-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment-address #button-address').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#shipping-address #button-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#shipping-address #button-address').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-guest').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-payment').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment').after('<span class="wait">&nbsp;<img src="' + template_image + '/loading.gif" alt="" /></span>');
		},
		complete: function() {
