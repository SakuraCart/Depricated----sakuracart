...
$_['text_debug_hint']         = '<br /><span class="help">( Saves send/recv data to the system log. )</span>';
$_['text_test_hint']           = '<br /><span class="help">( Use this module in Test (YES) or Production mode (NO)? )</span>';
$_['text_key_hint']           = '<br /><span class="help">( Enter the XML rates access key assigned to you by UPS. )</span>';
$_['text_username_hint']               = '<br /><span class="help">( Enter your UPS Services account username. )</span>';
$_['text_password_hint']               = '<br /><span class="help">( Enter your UPS Services account password. )</span>';

$_['text_insurance_hint']              = '<br /><span class="help">( Enables insurance with product total as the value. )</span>';
$_['text_display_weight_hint']         = '<br /><span class="help">( Do you want to display the shipping weight? (e.g. Delivery Weight : 2.7674 Kg\'s) )</span>';
$_['text_weight_code_hint']            = '<br /><span class="help">( Allowed kgs or lbs. Make sure you match the weight class with the UPS accepted weight code. )</span>';
$_['text_weight_class_hint']           = '<br /><span class="help">( Set to kilograms or pounds. )</span>';
$_['text_length_code_hint']            = '<br /><br /><span class="help">( Make sure you match the measurement class with the measurement code. )</span>';
$_['text_length_class_hint']           = '<br /><span class="help">( Set to centimeters or inches. )</span>';
$_['text_dimension_hint']        = '<br /><span class="help">( This is assumed to be your average packing box size. Individual item dimensions are not supported at this time so you must enter average dimensions like 5x5x5. )</span>';

$_['text_origin_hint']                 = '<br /><span class="help">( What origin point should be used (this setting affects only what UPS product names are shown to the user) )</span>';
$_['text_city_hint']                   = '<br /><span class="help">( Enter the name of the origin city. )</span>';
$_['text_state_hint']                  = '<br /><span class="help">( Enter the two-letter code for your origin state/province. )</span>';
$_['text_country_hint']                = '<br /><span class="help">( Enter the two-letter code for your origin country. )</span>';
$_['text_postcode_hint']               = '<br /><span class="help">( Enter your origin zip/postalcode. )</span>';

$_['text_classification_hint']         = '<br /><span class="help">( 01 - If you are billing to a UPS account and have a daily UPS pickup, 03 - If you do not have a UPS account or you are billing to a UPS account but do not have a daily pickup, 04 - If you are shipping from a retail outlet (only used when origin is US) )</span>';
$_['text_service_hint']                = '<br /><span class="help">( Select the UPS services to be offered. )</span>';
$_['text_pickup_hint']                 = '<br /><span class="help">( How do you give packages to UPS (only used when origin is US)? )</span>';
$_['text_quote_type_hint']             = '<br /><span class="help">( Quote for Residential or Commercial Delivery. )</span>';
$_['text_packaging_hint']              = '<br /><span class="help">( What kind of packaging do you use? )</span>';

$_['column_debug']           = 'Debug Mode';
$_['column_test_mode']            = 'Test Mode';
$_['column_key']                    = 'Access Key';
$_['column_username']               = 'Username';
$_['column_password']               = 'Password';

$_['column_insurance']              = 'Enable Insurance';
$_['column_display_weight']         = 'Display Delivery Weight';
$_['column_weight_code']            = 'Weight Code';
$_['column_weight_class']           = 'Weight Class';
$_['column_length_code']            = 'Length Code';
$_['column_length_class']           = 'Length Class';
$_['column_dimension']              = 'Dimensions (L x W x H)';

$_['column_origin']                 = 'Shipping Origin Code';
$_['column_city']                   = 'Origin City';
$_['column_state']                  = 'Origin State/Province';
$_['column_country']                = 'Origin Country';
$_['column_postcode']               = 'Origin Zip/Postal Code';

$_['column_classification']         = 'Customer Classification Code';
$_['column_service']                = 'Services';
$_['column_pickup']                 = 'Pickup Method';
$_['column_quote_type']             = 'Quote Type';
$_['column_packaging']              = 'Packaging Type';
