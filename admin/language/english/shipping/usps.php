...
$_['text_firstclass_hint']      = '<br/><span class="help">First class applies to 13oz packages or less. When disabled, standard premium rates are returned.</span>';
$_['text_dimension_hint']       = '<br/><span class="help">Average package dimensions for shipping package. Product dimensions are not used for shipping at this time.</span>';
...
$_['text_weight_class_hint']    = '<br /><span class="help">Must be set to Pound.</span>';
$_['text_debug_hint']           = '<br /><span class="help">Saves send/recv data to the system log</span>';

//column
$_['column_user_id']         = 'User ID';
$_['column_postcode']        = 'Zip Code';
$_['column_domestic']        = 'Domestic Services';
$_['column_international']   = 'International Services';
$_['column_size']            = 'Size';
$_['column_container']       = 'Container';
$_['column_machinable']      = 'Machinable';
$_['column_firstclass']      = 'Domestic First Class Rate Type';
$_['column_dimension']       = 'Dimensions (L x W x H)';
$_['column_girth']           = 'Girth';
