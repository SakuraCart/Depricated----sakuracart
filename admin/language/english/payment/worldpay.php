...
$_['text_password_hint']     = '<br /><span class="help">( This has to be set in the WordPay control panel. )</span>';
$_['text_callback_hint']     = '<br /><span class="help">( This has to be set in the WordPay control panel. You will also need to check the "Enable the Shopper Response". )</span>';
...
// column
$_['column_password']     = 'Payment Response password';
$_['column_callback']     = 'Relay Response URL';
