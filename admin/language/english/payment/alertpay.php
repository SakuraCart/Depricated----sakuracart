...
$_['text_callback_hint']     = '<br /><span class="help">( This has to be set in the AlertPay control panel. You will also need to check the "IPN Status" to enabled. )</span>';
...
//column
$_['column_callback']     = 'Alert URL';
$_['column_security']     = 'Security Code';
