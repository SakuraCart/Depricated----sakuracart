...
<script type="text/javascript" src="../js/jquery/ui/external/jquery.bgiframe-2.1.2.js"></script>
<script type="text/javascript" src="../js/libs/jstree/jquery.tree.min.js"></script>
<script type="text/javascript" src="../js/libs/ajaxupload.js"></script>
<style type="text/css">
body {
	padding: 0;
	margin: 0;
...
//		parent.$('#<?php echo $field; ?>').attr('value', 'data/' + $(this).attr('file'));
	...
	new AjaxUpload('#upload', {
		...
		onSubmit: function(file, extension) {
			$('#upload').append('<img src="<?php echo URL_IMAGE; ?>/loading.gif" class="loading" style="padding-left: 5px;" />');
		},
