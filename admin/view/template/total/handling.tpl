			...
			<table class="">
				<thead>
					<tr>
						...
						<th scope="col" class="center"><?php echo $column_fee; ?></th>
				...
				<tbody>
						<tr>
							...
							<td class="">
								<select name="handling_tax_class_id">
							...
							<td class="">
								<input type="text" name="handling_sort_order" value="<?php echo $handling_sort_order; ?>" size="1" />
							</td>
							<td class="">
