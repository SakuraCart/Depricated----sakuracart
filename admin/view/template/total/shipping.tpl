...
<section class="box_content rounded_corners_all border_green">
	<h2 class="box_content rounded_corners_all border_blue gradient_blue">
		<img src="<?php echo ICON; ?>32/cash_register.png" alt="lock" /> <?php echo $heading_title; ?>
	</h2>
	...
	<div id="content">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<table class="">
				<thead>
					<tr>
						<th scope="col" class="center"><?php echo $column_estimator; ?></th>
				...
				<tbody>
						<tr>
							<td class="">
								<select name="shipping_estimator">
							...
							<td class="">
								<input type="text" name="shipping_sort_order" value="<?php echo $shipping_sort_order; ?>" size="1" />
							</td>
							<td class="">
