			...
			<table id="module" class="">
				<thead>
					<tr>
						...
						<th scope="col" class="center"><?php echo $column_banner; ?></th>
						<th scope="col" class="center"><?php echo $column_scroll; ?></th>
					...
					<tr>
						...
						<td>
							<?php if (isset($error_image[$module_row])) { ?>
								<input type="text" name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" placeholder="<?php echo $error_width; ?>" class="input_error" />
								<input type="text" name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" placeholder="<?php echo $error_height; ?>" class="input_error" />
							<?php } else { ?>
								<input type="text" name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
								<input type="text" name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3" />
							<?php } ?>
							<?php echo $text_image_hint; ?>
						</td>
						<td>
							<select name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][banner_id]">
						...
						<td>
							<input type="text" name="<?php echo $module_name; ?>[<?php echo $module_row; ?>][scroll]" value="<?php echo $module['scroll']; ?>" size="3" />
						</td>
						<td class="center">
...
function addModule() {
	...
	html += '<td><input type="text" name="<?php echo $module_name ?>[' + module_row + '][width]" value="" size="3" /> <input type="text" name="<?php echo $module_name ?>[' + module_row + '][height]" value="" size="3" /></td><?php echo $text_dimension_hint; ?>';
	html += '<td><select name="<?php echo $module_name ?>[' + module_row + '][banner_id]">';
	<?php foreach ($banners as $banner) { ?>
		html += '<option value="<?php echo $banner['banner_id']; ?>"><?php echo addslashes($banner['name']); ?></option>';
	<?php } ?>
	html += '</select></td>';
	html += '<td><input type="text" name="<?php echo $module_name ?>[' + module_row + '][scroll]" value="3" size="1" /></td>';
