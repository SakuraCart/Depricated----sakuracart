			...
			<table class="">
				<tr>
					...
					<td class="textleft">
						...
						<?php echo $text_product_hint; ?>
					</td>
				</tr>
				<tr>
					<th><?php echo $entry_product; ?></th>
					<td class="none">
						<div class="scrollbox" id="featured-product">
							<?php $class = 'odd'; ?>
							<?php foreach ($products as $product) { ?>
								<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
								<div id="featured-product<?php echo $product['product_id']; ?>" class="<?php echo $class; ?>">
									<?php echo $product['name']; ?> <img src="<?php echo ICON; ?>16/delete.png" />
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#featured-product').append('<div id="featured-product' + ui.item.value + '">' + ui.item.label + '<img src="<?php echo ICON; ?>16/delete.png" /><input type="hidden" value="' + ui.item.value + '" /></div>');
