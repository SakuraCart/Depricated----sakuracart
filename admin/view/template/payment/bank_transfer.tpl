	...
	<div id="content">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<table class="">
				<thead>
					<tr>
						<th scope="col" class="center"><?php echo $column_bank; ?></th>
							...
							<td class="">
								<?php foreach ($languages as $language) { ?>
									<?php if (${'error_bank_' . $language['language_id']}) { ?>
										<textarea name="bank_transfer_bank_<?php echo $language['language_id']; ?>" cols="70" rows="10" placeholder="<?php echo ${'error_bank_' . $language['language_id']}; ?>" class="input_error"><?php echo isset(${'bank_transfer_bank_' . $language['language_id']}) ? ${'bank_transfer_bank_' . $language['language_id']} : ''; ?></textarea>
										<img src="../image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
									<?php } else { ?>
										<textarea name="bank_transfer_bank_<?php echo $language['language_id']; ?>" cols="70" rows="10"><?php echo isset(${'bank_transfer_bank_' . $language['language_id']}) ? ${'bank_transfer_bank_' . $language['language_id']} : ''; ?></textarea>
										<img src="../image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
									<?php } ?>
								<?php } ?>
							</td>
