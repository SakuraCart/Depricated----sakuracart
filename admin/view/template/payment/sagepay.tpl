			...
			<table class="">
				...
				<tbody>
						<tr>
							<td class="">
								<?php if ($error_vendor) { ?>
									<input type="text" name="sagepay_vendor" value="<?php echo $sagepay_vendor; ?>" placeholder="<?php echo $error_vendor; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td class="">
								<?php if ($error_password) { ?>
									<input type="text" name="sagepay_password" value="<?php echo $sagepay_password; ?>" placeholder="<?php echo $error_password; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td>
								<input type="text" name="sagepay_total" value="<?php echo $sagepay_total; ?>" />
