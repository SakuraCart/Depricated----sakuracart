	...
	<div id="content">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<table class="">
				<thead>
					<tr>
						<th scope="col" class="center"><?php echo $column_auth_id; ?></th>
						<th scope="col" class="center"><?php echo $column_auth_pass; ?></th>
						...
						<tr>
							<td class="">
								<?php if ($error_auth_id) { ?>
									<input type="text" name="perpetual_payments_auth_id" value="<?php echo $perpetual_payments_auth_id; ?>" placeholder="<?php echo $error_auth_id; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td class="">
								<?php if ($error_auth_pass) { ?>
									<input type="text" name="perpetual_payments_auth_pass" value="<?php echo $perpetual_payments_auth_pass; ?>" placeholder="<?php echo $error_auth_pass; ?>" class="input_error" />
								<?php } else { ?>
