						...
						<tr>
							<td class="">
								<?php if ($error_username) { ?>
									<input type="text" name="pp_pro_username" value="<?php echo $pp_pro_username; ?>" placeholder="<?php echo $error_username; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td class="">
								<?php if ($error_password) { ?>
									<input type="text" name="pp_pro_password" value="<?php echo $pp_pro_password; ?>" placeholder="<?php echo $error_password; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td class="">
								<?php if ($error_signature) { ?>
									<input type="text" name="pp_pro_signature" value="<?php echo $pp_pro_signature; ?>" placeholder="<?php echo $error_signature; ?>" class="input_error" />
								<?php } else { ?>
