			...
			<table class="">
				<thead>
					<tr>
						...
						<th scope="col" class="center"><?php echo $column_hash; ?></th>
						<th scope="col" class="center"><?php echo $column_server; ?></th>
				...
				<tbody>
						<tr>
							<td class="">
								<?php if ($error_login) { ?>
									<input type="text" name="authorizenet_aim_login" value="<?php echo $authorizenet_aim_login; ?>" placeholder="<?php echo $error_login; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td class="">
								<?php if ($error_key) { ?>
									<input type="text" name="authorizenet_aim_key" value="<?php echo $authorizenet_aim_key; ?>" placeholder="<?php echo $error_key; ?>" class="input_error" />
								<?php } else { ?>
							...
							<td>
								<input type="text" name="authorizenet_aim_total" value="<?php echo $authorizenet_aim_total; ?>" />
			...
			<table class="">
				...
				<tbody>
						<tr>
							...
							<td class="textcenter">
								<input type="text" name="authorizenet_aim_sort_order" value="<?php echo $authorizenet_aim_sort_order; ?>" size="1" />
							</td>
							<td class="">
