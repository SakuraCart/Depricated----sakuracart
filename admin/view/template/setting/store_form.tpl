		...
		<table class="">
			<tbody>
				<tr>
					...
					<td class="textleft">
						<?php if ($error_url) { ?>
							<input type="text" name="config_url" value="<?php echo $config_url; ?>" placeholder="<?php echo $error_url; ?>" class="input_error" />
						<?php } else { ?>
				...
				<tr>
					...
					<td class="textleft">
						<div class="image">
							...
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a onclick="$('#thumb-icon').attr('src', '<?php echo $no_image; ?>'); $('#icon').attr('value', '');"><?php echo $text_clear; ?></a>
						</div>
					</td>
				</tr>
				<tr>
