			...
			<table class="">
				<thead>
					<tr>
						...
						<th scope="col" class="center"><?php echo $column_article; ?></th>
						...
						<tr>
							...
							<td class="texttop">
								...
								<?php if ($error_article) { ?>
									<input type="text" name="article" value="<?php echo $article; ?>" placeholder="<?php echo $error_article; ?>" class="input_error" />
								<?php } else { ?>
