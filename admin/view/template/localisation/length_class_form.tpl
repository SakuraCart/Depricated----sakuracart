							...
							<td scope="row" class="">
								<?php foreach ($languages as $language) { ?>
									<?php if (isset($error_title[$language['language_id']])) { ?>
										<input type="text" name="length_class_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($length_class_description[$language['language_id']]) ? $length_class_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $error_title[$language['language_id']]; ?>" class="input_error" />
									<?php } else { ?>
							...
							<td scope="row" class="">
								<?php foreach ($languages as $language) { ?>
									<?php if (isset($error_unit[$language['language_id']])) { ?>
										<input type="text" name="length_class_description[<?php echo $language['language_id']; ?>][unit]" value="<?php echo isset($length_class_description[$language['language_id']]) ? $length_class_description[$language['language_id']]['unit'] : ''; ?>" placeholder="<?php echo $error_unit[$language['language_id']]; ?>" class="input_error" />
									<?php } else { ?>
