...
$this->document->addBreadcrumbs(
	...
	$this->language->get('text_separator')
		...
		if (!isset($this->request->get['category_id'])) {
			...
			$this->data['action'] = $this->url->link('forum/forum_category/update', 'token=' . $this->session->data['token'] . '&category_id=' . $this->request->get['category_id'], 'SSL');
		}
	...
	private function validateForm() {
		if (!$this->user->hasPermission('modify', 'forum/forum_category')) {
