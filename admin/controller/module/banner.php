...
class ControllerModuleBanner extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('module/banner'));
		$this->document->setTitle($this->language->get('heading_title'));
		$this->data['module_name'] = 'banner' . '_module';
...
$this->document->addBreadcrumbs(
	$this->url->link('module/banner', 'token=' . $this->session->data['token'], 'SSL'),
