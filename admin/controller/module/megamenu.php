...
class ControllerModuleMegamenu extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('module/megamenu'));
		$this->document->setTitle($this->language->get('heading_title'));
		$this->data['module_name'] = 'megamenu' . '_module';
...
$this->document->addBreadcrumbs(
	$this->url->link('module/megamenu', 'token=' . $this->session->data['token'], 'SSL'),
	...
	$this->language->get('text_separator')
		...
		if (isset($this->request->post['megamenu_module'])) {
			$this->data['modules'] = $this->request->post['megamenu_module'];
		} elseif ($this->config->get('megamenu_module')) {
			$this->data['modules'] = $this->config->get('megamenu_module');
		}
