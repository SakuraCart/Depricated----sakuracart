...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('module/slideshow'));
		$this->document->setTitle($this->language->get('heading_title'));
		$this->data['module_name'] = 'slideshow' . '_module';
...
$this->document->addBreadcrumbs(
	$this->url->link('module/slideshow', 'token=' . $this->session->data['token'], 'SSL'),
