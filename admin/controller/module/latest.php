...
class ControllerModuleLatest extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('module/latest'));
		$this->document->setTitle($this->language->get('heading_title'));
		$this->data['module_name'] = 'latest' . '_module';
...
$this->document->addBreadcrumbs(
	$this->url->link('module/latest', 'token=' . $this->session->data['token'], 'SSL'),
...
//		$this->document->addScript(URL_JS . 'admin/module.js');
