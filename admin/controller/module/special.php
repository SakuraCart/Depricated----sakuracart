...
class ControllerModuleSpecial extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('module/special'));
		$this->document->setTitle($this->language->get('heading_title'));
		$this->data['module_name'] = 'special' . '_module';
...
$this->document->addBreadcrumbs(
	$this->url->link('module/special', 'token=' . $this->session->data['token'], 'SSL'),
