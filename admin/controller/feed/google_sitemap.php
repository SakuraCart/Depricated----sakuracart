...
class ControllerFeedGoogleSitemap extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('feed/google_sitemap'));
...
$this->document->addBreadcrumbs(
	...
	$this->language->get('text_feed'),
	$this->language->get('text_separator')
);
$this->document->addBreadcrumbs(
	$this->url->link('feed/google_sitemap', 'token=' . $this->session->data['token'], 'SSL'),
