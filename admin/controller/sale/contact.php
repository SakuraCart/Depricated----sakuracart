...
class ControllerSaleContact extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('sale/contact'));
...
$this->document->addBreadcrumbs(
	$this->url->link('sale/contact', 'token=' . $this->session->data['token'], 'SSL'),
	...
	$this->language->get('text_separator')
		...
		$this->document->addScript(URL_JS . 'libs/ckeditor/adapters/jquery.js');
