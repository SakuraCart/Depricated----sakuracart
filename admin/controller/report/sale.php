...
class ControllerReportSale extends Controller {
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('report/sale'));
...
$this->document->addBreadcrumbs(
	$this->url->link('report/sale', 'token=' . $this->session->data['token'] . $url, 'SSL'),
	...
	$this->language->get('text_separator')
		...
		$pagination->url = $this->url->link('report/sale', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
