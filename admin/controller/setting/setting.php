...
// forums
		if (isset($this->request->post['config_thread_status'])) {
			$this->data['config_thread_status'] = $this->request->post['config_thread_status'];
		} else {
			$this->data['config_thread_status'] = $this->config->get('config_thread_status');
		}

		if (isset($this->request->post['config_post_status'])) {
			$this->data['config_post_status'] = $this->request->post['config_post_status'];
		} else {
			$this->data['config_post_status'] = $this->config->get('config_post_status');
		}
