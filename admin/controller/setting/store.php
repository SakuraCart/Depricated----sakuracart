...
class ControllerSettingStore extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('setting/store'));
...
$this->document->addBreadcrumbs(
	...
	public function getForm() {
		...
		if (isset($this->error['image_readlist'])) {
			$this->data['error_image_readlist'] = $this->error['image_readlist'];
		} else {
			$this->data['error_image_readlist'] = '';
		}

		if (isset($this->error['image_slider'])) {
			$this->data['error_image_slider'] = $this->error['image_slider'];
		} else {
			$this->data['error_image_slider'] = '';
		}
...
$this->document->addBreadcrumbs(
	...
	$this->language->get('text_separator')
		...
		} elseif (isset($store_info['config_admin_language'])) {
			$this->data['config_admin_language'] = $store_info['config_admin_language'];
		} else {
		...
		if (isset($this->request->post['config_image_slider_width'])) {
			$this->data['config_image_slider_width'] = $this->request->post['config_image_slider_width'];
		} elseif (isset($store_info['config_image_slider_width'])) {
			$this->data['config_image_slider_width'] = $store_info['config_image_slider_width'];
		} else {
			$this->data['config_image_slider_width'] = $this->config->get('config_image_slider_width');
		}

		if (isset($this->request->post['config_image_slider_height'])) {
			$this->data['config_image_slider_height'] = $this->request->post['config_image_slider_height'];
		} elseif (isset($store_info['config_image_slider_height'])) {
			$this->data['config_image_slider_height'] = $store_info['config_image_slider_height'];
		} else {
			$this->data['config_image_slider_height'] = $this->config->get('config_image_slider_height');
		}
		...
		if (isset($this->request->post['config_image_readlist_width'])) {
			$this->data['config_image_readlist_width'] = $this->request->post['config_image_readlist_width'];
		} elseif (isset($store_info['config_image_readlist_width'])) {
			$this->data['config_image_readlist_width'] = $store_info['config_image_readlist_width'];
		} else {
			$this->data['config_image_readlist_width'] = $this->config->get('config_image_readlist_width');
		}

		if (isset($this->request->post['config_image_readlist_height'])) {
			$this->data['config_image_readlist_height'] = $this->request->post['config_image_readlist_height'];
		} elseif (isset($store_info['config_image_readlist_height'])) {
			$this->data['config_image_readlist_height'] = $store_info['config_image_readlist_height'];
		} else {
			$this->data['config_image_readlist_height'] = $this->config->get('config_image_readlist_height');
		}
	...
	private function validateForm() {
		...
		if (!$this->request->post['config_image_slider_width'] || !$this->request->post['config_image_slider_height']) {
			$this->error['image_slider'] = $this->language->get('error_image_slider');
		}
		...
		if (!$this->request->post['config_image_readlist_width'] || !$this->request->post['config_image_readlist_height']) {
			$this->error['image_readlist'] = $this->language->get('error_image_readlist');
		}
