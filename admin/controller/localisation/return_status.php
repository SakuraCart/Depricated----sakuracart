...
class ControllerLocalisationReturnStatus extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('localisation/return_status'));
...
$this->document->addBreadcrumbs(
	$this->url->link('localisation/return_status', 'token=' . $this->session->data['token'] . $url, 'SSL'),
