...
class ControllerLocalisationWeightClass extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('localisation/weight_class'));
...
$this->document->addBreadcrumbs(
	$this->url->link('localisation/weight_class', 'token=' . $this->session->data['token'] . $url, 'SSL'),
