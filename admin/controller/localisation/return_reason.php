...
class ControllerLocalisationReturnReason extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('localisation/return_reason'));
...
$this->document->addBreadcrumbs(
	$this->url->link('localisation/return_reason', 'token=' . $this->session->data['token'] . $url, 'SSL'),
