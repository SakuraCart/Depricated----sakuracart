...
class ControllerLocalisationReturnAction extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('localisation/return_action'));
...
$this->document->addBreadcrumbs(
	$this->url->link('localisation/return_action', 'token=' . $this->session->data['token'] . $url, 'SSL'),
