...
class ControllerLocalisationLengthClass extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('localisation/length_class'));
...
$this->document->addBreadcrumbs(
	$this->url->link('localisation/length_class', 'token=' . $this->session->data['token'] . $url, 'SSL'),
