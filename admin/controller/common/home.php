...
class ControllerCommonHome extends Controller {
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('common/home'));
...
//			$this->data['error_image_cache'] = sprintf($this->language->get('error_image_cache'). DIR_IMAGE . 'cache/');
			$this->data['error_image_cache'] = sprintf($this->language->get('error_image_cache'). DIR_IMAGE_CACHE);
		} else {
...
$this->document->addBreadcrumbs(
	...
	false
		...
		$this->document->addScript(URL_JS . 'jquery/flot/jquery.flot.js');
		$this->document->addScript(URL_JS . 'jquery/flot/excanvas.js');
//		$this->document->addScript(URL_JS . 'admin/home.js');
