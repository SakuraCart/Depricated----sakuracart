...
class ControllerCommonFileManager extends Controller {
	...
	public function index() {
		$this->data = array_merge($this->data, $this->load->language('common/filemanager'));
...
//			$directories = glob(rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', $this->request->post['directory']), '/') . '/*', GLOB_ONLYDIR);
			$directories = glob(rtrim(DIR_IMAGE . str_replace('../', '', $this->request->post['directory']), '/') . '/*', GLOB_ONLYDIR);
			if ($directories) {
				$i = 0;
...
//			$directory = DIR_IMAGE . 'data/' . str_replace('../', '', $this->request->post['directory']);
			$directory = DIR_IMAGE . str_replace('../', '', $this->request->post['directory']);
		} else {
...
//				$directory = rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', $this->request->post['directory']), '/');
				$directory = rtrim(DIR_IMAGE . str_replace('../', '', $this->request->post['directory']), '/');
				if (!is_dir($directory)) {
...
//			$path = rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
			$path = rtrim(DIR_IMAGE . str_replace('../', '', html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
			if (!file_exists($path)) {
...
//			$from = rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', html_entity_decode($this->request->post['from'], ENT_QUOTES, 'UTF-8')), '/');
			$from = rtrim(DIR_IMAGE . str_replace('../', '', html_entity_decode($this->request->post['from'], ENT_QUOTES, 'UTF-8')), '/');
...
//			$to = rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', html_entity_decode($this->request->post['to'], ENT_QUOTES, 'UTF-8')), '/');
			$to = rtrim(DIR_IMAGE . str_replace('../', '', html_entity_decode($this->request->post['to'], ENT_QUOTES, 'UTF-8')), '/');
...
//			$old_name = rtrim(DIR_IMAGE . 'data/' . str_replace('../', '', html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
			$old_name = rtrim(DIR_IMAGE . str_replace('../', '', html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
...
//		$this->response->setOutput($this->recursiveFolders(DIR_IMAGE . 'data/'));
		$this->response->setOutput($this->recursiveFolders(DIR_IMAGE));
	}
