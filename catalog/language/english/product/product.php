...
$_['text_regular_price']  = 'Regular:';
$_['text_sale_price']     = 'Sale:';
$_['text_display']      = 'Display:';
$_['text_list']         = 'List';
$_['text_grid']         = 'Grid';

$_['text_review_login']  = 'To write a review you need to <a href="%s">login</a> or <a href="%s">create an account</a>.';

//$_['text_discount']     = '%s or more %s';
$_['text_discount']     = '<strong>%s or more</strong> <em>%s</em>';
// Entry
$_['entry_price']        = 'Price:';
$_['entry_special']      = 'Special:';
$_['entry_tax']          = 'Ex Tax:';
$_['entry_reward']       = 'Reward Points:';
$_['entry_points']       = 'Price in reward points:';
$_['entry_tags']         = 'Tags:';
