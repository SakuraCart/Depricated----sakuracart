...
//		$this->data['box_position'] = $setting['position'] ?: '';
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/article_latest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/article_latest.tpl';
		} else {
			$this->template = 'default/template/module/article_latest.tpl';
		}
