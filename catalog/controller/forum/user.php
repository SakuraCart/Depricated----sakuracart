...
/*
			if (!isset($this->data['users'][$key])) {
				$this->data['members'][$key]['name'] = $key;
			}

			$this->data['members'][$key]['user'][] = array(
...
*/
			if (!isset($this->data['users'][$key])) {
				$this->data['members'][$key]['username'] = $key;
			}
...
//			$this->data['heading_title'] = $user_info['name'],
			$this->data['heading_title'] = $user_info['username'];
...
//					'href'        => $this->url->link('forum/forum', $url . '&user_id=' . $result['user_id'] . '&thread_id=' . $result['thread_id'])
					'href'        => $this->url->link('forum/thread', $url . '&user_id=' . $result['user_id'] . '&thread_id=' . $result['thread_id'])
				);
			}
			...
			$this->data['sorts'][] = array(
				'text'  => $this->language->get('text_username_asc'),
				'value' => 'p.username-ASC',
				'href'  => $this->url->link('forum/user/thread', 'user_id=' . $this->request->get['user_id'] . '&sort=p.username&order=ASC' . $url)
			);

			$this->data['sorts'][] = array(
				'text'  => $this->language->get('text_username_desc'),
				'value' => 'p.username-DESC',
				'href'  => $this->url->link('forum/user/thread', 'user_id=' . $this->request->get['user_id'] . '&sort=p.username&order=DESC' . $url)
			);
/*
			$this->data['sorts'][] = array(
