<?php
class ControllerProductVoucher extends Controller {
	private $error = array();
	public function index() {
//		$this->language->load('product/voucher');
		$this->data = array_merge($this->data, $this->load->language('product/voucher'));
		...
		$this->load->model('product/voucher');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->redirect($this->url->link('product/voucher/success'));
		}
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('product/voucher', '', 'SSL'),
