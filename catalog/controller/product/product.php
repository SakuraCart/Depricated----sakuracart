...
*/
		...
		$this->document->addBreadcrumbs(
			$this->url->link('product/manufacturer/product', 'manufacturer_id=' . $this->request->get['manufacturer_id']),
...
*/
		...
		$this->document->addBreadcrumbs(
			$this->url->link('product/product', $url . '&product_id=' . $this->request->get['product_id']),
			$product_info['name'],
			$this->language->get('text_separator')
		);
...
// need a summary -- use meta_description as quick fix
			...
			if ($product_info['image']) {
				$this->data['slider'] = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_slider_width'), $this->config->get('config_image_slider_height'));
			} else {
				$this->data['slider'] = '';
			}
...
//				$this->data['price'] = $this->currency->fancy_format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')));
			} else {
...
*/
			...
			if ($this->data['options']) {
				$this->document->addScript(URL_JS . 'libs/ajaxupload.js');
				foreach ($this->data['options'] as $option) {
					if ($option['type'] == 'file') {
			//		$this->document->addScript(URL_JS . 'mylibs/product/product_upload.js');
					}
				}
			}
...
//			$this->document->addStyle(URL_THEME . $this->config->get('config_template') . '/stylesheet/table.css');
			...
			$this->document->addScript(URL_JS . 'mylibs/tabs.js');
			$this->document->addScript(URL_JS . 'mylibs/product/product.js');
