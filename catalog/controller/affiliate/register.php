...
//		$this->data = array_merge($this->data, $this->load->language('account/account'));
		$this->data = array_merge($this->data, $this->load->language('affiliate/register'));
...
*/
		...
		$this->document->addBreadcrumbs(
			...
			$this->language->get('text_register'),
			$this->language->get('text_separator')
		);
		...
		$this->document->addStyle(URL_JS . 'libs/colorbox/colorbox.css');
