...
DROP TABLE IF EXISTS `sc_affiliate`;
CREATE TABLE `sc_affiliate` (
...
DROP TABLE IF EXISTS `sc_affiliate_transaction`;
CREATE TABLE `sc_affiliate_transaction` (
...
DROP TABLE IF EXISTS `sc_article_category`;
CREATE TABLE `sc_article_category` (
...
DROP TABLE IF EXISTS `sc_article_category_description`;
CREATE TABLE `sc_article_category_description` (
...
DROP TABLE IF EXISTS `sc_article_category_to_layout`;
CREATE TABLE `sc_article_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_category_to_store`;
CREATE TABLE `sc_article_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `sc_article_description`;
CREATE TABLE `sc_article_description` (
  `article_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_download`;
CREATE TABLE `sc_article_download` (
...
DROP TABLE IF EXISTS `sc_article_download_description`;
CREATE TABLE `sc_article_download_description` (
...
DROP TABLE IF EXISTS `sc_article_headline`;
CREATE TABLE `sc_article_headline` (
  `article_headline_id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  `priority` int(5) NOT NULL DEFAULT '1',
  `date_start` date NOT NULL DEFAULT '0000-00-00',
  `date_end` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`article_headline_id`),
  KEY `thread_id` (`article_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_article_image`;
CREATE TABLE `sc_article_image` (
  `article_image_id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` int(11) NOT NULL,
  `image` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `sort_order` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`article_image_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='`sort_order` int(3) NOT NULL DEFAULT ''0'',';


DROP TABLE IF EXISTS `sc_article_related`;
CREATE TABLE `sc_article_related` (
  `article_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_reward`;
CREATE TABLE `sc_article_reward` (
  `article_reward_id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` int(11) NOT NULL DEFAULT '0',
  `customer_group_id` int(11) NOT NULL DEFAULT '0',
  `points` int(8) NOT NULL DEFAULT '0',
  PRIMARY KEY (`article_reward_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_article_status`;
CREATE TABLE `sc_article_status` (
  `article_status_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`article_status_id`,`language_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_article_tag`;
CREATE TABLE `sc_article_tag` (
...
DROP TABLE IF EXISTS `sc_article_to_category`;
CREATE TABLE `sc_article_to_category` (
  `article_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_to_download`;
CREATE TABLE `sc_article_to_download` (
  `article_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_to_layout`;
CREATE TABLE `sc_article_to_layout` (
  `article_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_article_to_store`;
CREATE TABLE `sc_article_to_store` (
  `article_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_attribute`;
CREATE TABLE `sc_attribute` (
...
DROP TABLE IF EXISTS `sc_attribute_description`;
CREATE TABLE `sc_attribute_description` (
...
DROP TABLE IF EXISTS `sc_attribute_group`;
CREATE TABLE `sc_attribute_group` (
...
DROP TABLE IF EXISTS `sc_attribute_group_description`;
CREATE TABLE `sc_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `sc_author`;
CREATE TABLE `sc_author` (
...
DROP TABLE IF EXISTS `sc_author_to_store`;
CREATE TABLE `sc_author_to_store` (
  `author_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_banner_image`;
CREATE TABLE `sc_banner_image` (
...
DROP TABLE IF EXISTS `sc_banner_image_description`;
CREATE TABLE `sc_banner_image_description` (
...
DROP TABLE IF EXISTS `sc_category_to_layout`;
CREATE TABLE `sc_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
...
DROP TABLE IF EXISTS `sc_category_to_store`;
CREATE TABLE `sc_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `sc_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
DROP TABLE IF EXISTS `sc_coupon_history`;
CREATE TABLE `sc_coupon_history` (
...
DROP TABLE IF EXISTS `sc_coupon_product`;
CREATE TABLE `sc_coupon_product` (
...
DROP TABLE IF EXISTS `sc_currency`;
...
INSERT INTO `sc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.63209999, 1, '2012-03-09 04:47:53'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2012-03-13 01:05:27'),
(3, 'Euro', 'EUR', '', '€', '2', 0.75400001, 1, '2012-03-09 04:47:53');
...
DROP TABLE IF EXISTS `sc_customer_group`;
CREATE TABLE `sc_customer_group` (
...
DROP TABLE IF EXISTS `sc_customer_ip`;
CREATE TABLE `sc_customer_ip` (
...
DROP TABLE IF EXISTS `sc_customer_ip_blacklist`;
CREATE TABLE `sc_customer_ip_blacklist` (
...
DROP TABLE IF EXISTS `sc_customer_reward`;
CREATE TABLE `sc_customer_reward` (
...
DROP TABLE IF EXISTS `sc_customer_transaction`;
CREATE TABLE `sc_customer_transaction` (
...
DROP TABLE IF EXISTS `sc_download`;
...
DROP TABLE IF EXISTS `sc_download_description`;
CREATE TABLE `sc_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`download_id`,`language_id`)
...
DROP TABLE IF EXISTS `sc_extension`;
CREATE TABLE `sc_extension` (
...
DROP TABLE IF EXISTS `sc_forum_category`;
CREATE TABLE `sc_forum_category` (
  `category_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `top` int(1) NOT NULL,
...
DROP TABLE IF EXISTS `sc_forum_category_description`;
CREATE TABLE `sc_forum_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `description` text COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `sc_forum_category_to_layout`;
CREATE TABLE `sc_forum_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
...
DROP TABLE IF EXISTS `sc_forum_category_to_store`;
CREATE TABLE `sc_forum_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `sc_forum_user`;
CREATE TABLE `sc_forum_user` (
...
DROP TABLE IF EXISTS `sc_forum_user_group`;
CREATE TABLE `sc_forum_user_group` (
...
DROP TABLE IF EXISTS `sc_geo_zone`;
CREATE TABLE `sc_geo_zone` (
...
DROP TABLE IF EXISTS `sc_information`;
...
DROP TABLE IF EXISTS `sc_information_description`;
CREATE TABLE `sc_information_description` (
...
DROP TABLE IF EXISTS `sc_information_to_layout`;
CREATE TABLE `sc_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_information_to_store`;
CREATE TABLE `sc_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `sc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
...
INSERT INTO `sc_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Store Default'),
...
DROP TABLE IF EXISTS `sc_layout_route`;
CREATE TABLE `sc_layout_route` (
...
DROP TABLE IF EXISTS `sc_length_class`;
CREATE TABLE `sc_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `sc_length_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);

DROP TABLE IF EXISTS `sc_length_class_description`;
CREATE TABLE `sc_length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
INSERT INTO `sc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
DROP TABLE IF EXISTS `sc_manufacturer_to_store`;
CREATE TABLE `sc_manufacturer_to_store` (
...
INSERT INTO `sc_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
DROP TABLE IF EXISTS `sc_option_description`;
CREATE TABLE `sc_option_description` (
...
INSERT INTO `sc_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
DROP TABLE IF EXISTS `sc_option_value`;
CREATE TABLE `sc_option_value` (
...
DROP TABLE IF EXISTS `sc_option_value_description`;
CREATE TABLE `sc_option_value_description` (
...
DROP TABLE IF EXISTS `sc_order_download`;
CREATE TABLE `sc_order_download` (
...
DROP TABLE IF EXISTS `sc_order_fraud`;
CREATE TABLE `sc_order_fraud` (
  `order_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_order_history`;
CREATE TABLE `sc_order_history` (
...
DROP TABLE IF EXISTS `sc_order_option`;
CREATE TABLE `sc_order_option` (
...
INSERT INTO `sc_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(4, 1, 'Processed'),
...
DROP TABLE IF EXISTS `sc_order_total`;
CREATE TABLE `sc_order_total` (
...
DROP TABLE IF EXISTS `sc_post_description`;
CREATE TABLE `sc_post_description` (
  `post_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `sc_post_to_download`;
CREATE TABLE `sc_post_to_download` (
  `thread_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
  PRIMARY KEY (`thread_id`,`download_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_post_to_thread`;
CREATE TABLE `sc_post_to_thread` (
...
DROP TABLE IF EXISTS `sc_product_attribute`;
CREATE TABLE `sc_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `sc_product_option`;
CREATE TABLE `sc_product_option` (
...
DROP TABLE IF EXISTS `sc_product_option_value`;
CREATE TABLE `sc_product_option_value` (
...
DROP TABLE IF EXISTS `sc_product_reward`;
CREATE TABLE `sc_product_reward` (
...
DROP TABLE IF EXISTS `sc_product_tag`;
CREATE TABLE `sc_product_tag` (
...
DROP TABLE IF EXISTS `sc_product_to_download`;
CREATE TABLE `sc_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_product_to_layout`;
CREATE TABLE `sc_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_product_to_store`;
CREATE TABLE `sc_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `sc_return`;
CREATE TABLE `sc_return` (
...
DROP TABLE IF EXISTS `sc_return_action`;
CREATE TABLE `sc_return_action` (
...
INSERT INTO `sc_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
(3, 1, 'Replacement Sent'),
(4, 1, 'Pending');

DROP TABLE IF EXISTS `sc_return_history`;
CREATE TABLE `sc_return_history` (
...
DROP TABLE IF EXISTS `sc_return_product`;
CREATE TABLE `sc_return_product` (
...
INSERT INTO `sc_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
DROP TABLE IF EXISTS `sc_return_status`;
CREATE TABLE `sc_return_status` (
...
INSERT INTO `sc_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
(2, 1, 'Awaiting Products');

DROP TABLE IF EXISTS `sc_review`;
...
INSERT INTO `sc_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
(1, 0, 'config', 'config_image_readlist_width', '50', 0),
(2, 0, 'config', 'config_image_readlist_height', '50', 0),
(3, 0, 'config', 'config_image_manufacturer_height', '80', 0),
(4, 0, 'config', 'config_image_manufacturer_width', '80', 0),
(5, 0, 'config', 'config_image_slider_height', '150', 0),
(6, 0, 'config', 'config_image_slider_width', '251', 0),
(7, 0, 'config', 'config_image_cart_height', '80', 0),
(8, 0, 'config', 'config_image_cart_width', '80', 0),
(9, 0, 'config', 'config_image_wishlist_height', '50', 0),
(10, 0, 'config', 'config_image_wishlist_width', '50', 0),
(11, 0, 'config', 'config_image_compare_height', '90', 0),
(12, 0, 'config', 'config_image_compare_width', '90', 0),
(13, 0, 'config', 'config_image_related_height', '80', 0),
(14, 0, 'config', 'config_image_related_width', '80', 0),
(15, 0, 'config', 'config_image_additional_height', '228', 0),
(16, 0, 'config', 'config_image_additional_width', '228', 0),
(17, 0, 'config', 'config_image_product_height', '80', 0),
(18, 0, 'config', 'config_image_product_width', '80', 0),
(19, 0, 'config', 'config_image_popup_height', '500', 0),
(20, 0, 'config', 'config_image_popup_width', '500', 0),
(21, 0, 'config', 'config_image_thumb_height', '70', 0),
(22, 0, 'config', 'config_image_thumb_width', '70', 0),
(23, 0, 'config', 'config_image_category_height', '80', 0),
(24, 0, 'config', 'config_image_category_width', '80', 0),
(25, 0, 'store', 'store_admin', '0', 0),
(26, 0, 'config', 'config_smtp_timeout', '5', 0),
(27, 0, 'config', 'config_smtp_port', '25', 0),
(28, 0, 'config', 'config_mail_protocol', 'mail', 0),
(29, 0, 'config', 'config_icon', '/icons/cart.png', 0),
(30, 0, 'config', 'config_logo', '/sakura_logo.png', 0),
(31, 0, 'config', 'config_cart_weight', '1', 0),
(32, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(33, 0, 'config', 'config_use_ssl', '0', 0),
(34, 0, 'config', 'config_admin_language', 'en', 0),
(35, 0, 'config', 'config_language', 'en', 0),
(36, 0, 'config', 'config_template', 'default', 0),
(37, 0, 'config', 'config_meta_description', 'My Store', 0),
(38, 0, 'config', 'config_title', 'My Store', 0),
(39, 0, 'config', 'config_maintenance', '1', 0),
(40, 0, 'config', 'config_encryption', '8921034765', 0),
(41, 0, 'config', 'config_compression', '0', 0),
(42, 0, 'config', 'config_error_display', '1', 0),
(43, 0, 'config', 'config_error_log', '1', 0),
(44, 0, 'config', 'config_error_filename', 'error.txt', 0);
...
INSERT INTO `sc_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(1, 1, 'In Stock'),
(2, 1, 'Pre-Order'),
(3, 1, 'Out Of Stock'),
(4, 1, '2 - 3 Days');
...
DROP TABLE IF EXISTS `sc_tax_class`;
...
DROP TABLE IF EXISTS `sc_tax_rate`;
...
DROP TABLE IF EXISTS `sc_tax_rate_to_customer_group`;
CREATE TABLE `sc_tax_rate_to_customer_group` (
...
DROP TABLE IF EXISTS `sc_tax_rule`;
CREATE TABLE `sc_tax_rule` (
...
DROP TABLE IF EXISTS `sc_thread`;
CREATE TABLE `sc_thread` (
  `thread_id` int(11) NOT NULL AUTO_INCREMENT,
  `model` varchar(64) COLLATE utf8_bin NOT NULL,
  `location` varchar(128) COLLATE utf8_bin NOT NULL,
  `thread_status_id` int(11) NOT NULL,
  `image` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `points` int(8) NOT NULL DEFAULT '0',
  `date_available` date NOT NULL,
...
DROP TABLE IF EXISTS `sc_thread_description`;
CREATE TABLE `sc_thread_description` (
  `thread_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_thread_image`;
CREATE TABLE `sc_thread_image` (
  `thread_image_id` int(11) NOT NULL AUTO_INCREMENT,
  `thread_id` int(11) NOT NULL,
  `image` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
DROP TABLE IF EXISTS `sc_thread_related`;
CREATE TABLE `sc_thread_related` (
  `thread_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`thread_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_thread_reward`;
CREATE TABLE `sc_thread_reward` (
  `thread_reward_id` int(11) NOT NULL AUTO_INCREMENT,
  `thread_id` int(11) NOT NULL DEFAULT '0',
  `customer_group_id` int(11) NOT NULL DEFAULT '0',
  `points` int(8) NOT NULL DEFAULT '0',
  PRIMARY KEY (`thread_reward_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_thread_status`;
CREATE TABLE `sc_thread_status` (
  `thread_status_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`thread_status_id`,`language_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_thread_tag`;
CREATE TABLE `sc_thread_tag` (
  `thread_tag_id` int(11) NOT NULL AUTO_INCREMENT,
  `thread_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `tag` varchar(32) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`thread_tag_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `sc_thread_to_category`;
CREATE TABLE `sc_thread_to_category` (
  `thread_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_thread_to_layout`;
CREATE TABLE `sc_thread_to_layout` (
  `thread_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sc_thread_to_store`;
CREATE TABLE `sc_thread_to_store` (
  `thread_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`thread_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `sc_url_alias`;
CREATE TABLE `sc_url_alias` (
...
INSERT INTO `sc_user_group` (`user_group_id`, `name`, `permission`) VALUES
(1, 'Top Administrator', 'a:2:{s:6:\"access\";a:188:{i:0;s:15:\"article/article\";i:1;s:24:\"article/article_category\";i:2;s:24:\"article/article_download\";i:3;s:14:\"article/author\";i:4;s:15:\"article/comment\";i:5;s:17:\"catalog/attribute\";i:6;s:23:\"catalog/attribute_group\";i:7;s:16:\"catalog/category\";i:8;s:16:\"catalog/download\";i:9;s:19:\"catalog/information\";i:10;s:20:\"catalog/manufacturer\";i:11;s:14:\"catalog/option\";i:12;s:15:\"catalog/product\";i:13;s:14:\"catalog/review\";i:14;s:18:\"common/filemanager\";i:15;s:13:\"design/banner\";i:16;s:13:\"design/layout\";i:17;s:14:\"extension/feed\";i:18;s:16:\"extension/module\";i:19;s:17:\"extension/payment\";i:20;s:18:\"extension/shipping\";i:21;s:15:\"extension/total\";i:22;s:16:\"feed/google_base\";i:23;s:19:\"feed/google_sitemap\";i:24;s:25:\"forum/___article_download\";i:25;s:20:\"forum/forum_category\";i:26;s:10:\"forum/post\";i:27;s:12:\"forum/thread\";i:28;s:10:\"forum/user\";i:29;s:20:\"localisation/country\";i:30;s:21:\"localisation/currency\";i:31;s:21:\"localisation/geo_zone\";i:32;s:21:\"localisation/language\";i:33;s:25:\"localisation/length_class\";i:34;s:25:\"localisation/order_status\";i:35;s:26:\"localisation/return_action\";i:36;s:26:\"localisation/return_reason\";i:37;s:26:\"localisation/return_status\";i:38;s:25:\"localisation/stock_status\";i:39;s:22:\"localisation/tax_class\";i:40;s:25:\"localisation/weight_class\";i:41;s:17:\"localisation/zone\";i:42;s:14:\"module/account\";i:43;s:16:\"module/affiliate\";i:44;s:23:\"module/article_category\";i:45;s:23:\"module/article_featured\";i:46;s:23:\"module/article_headline\";i:47;s:21:\"module/article_latest\";i:48;s:13:\"module/author\";i:49;s:13:\"module/banner\";i:50;s:17:\"module/bestseller\";i:51;s:15:\"module/carousel\";i:52;s:15:\"module/category\";i:53;s:15:\"module/featured\";i:54;s:21:\"module/forum_category\";i:55;s:19:\"module/forum_latest\";i:56;s:21:\"module/forum_megamenu\";i:57;s:18:\"module/google_talk\";i:58;s:18:\"module/information\";i:59;s:13:\"module/latest\";i:60;s:19:\"module/manufacturer\";i:61;s:15:\"module/megamenu\";i:62;s:16:\"module/slideshow\";i:63;s:12:\"module/spare\";i:64;s:14:\"module/special\";i:65;s:12:\"module/store\";i:66;s:16:\"module/supermenu\";i:67;s:14:\"module/welcome\";i:68;s:16:\"payment/alertpay\";i:69;s:24:\"payment/authorizenet_aim\";i:70;s:21:\"payment/bank_transfer\";i:71;s:14:\"payment/cheque\";i:72;s:11:\"payment/cod\";i:73;s:21:\"payment/free_checkout\";i:74;s:14:\"payment/liqpay\";i:75;s:20:\"payment/moneybookers\";i:76;s:14:\"payment/nochex
s:15:\"shipping/pickup\";i:151;s:23:\"shipping/parcelforce_48\";i:152;s:13:\"shipping/item\";i:153;s:13:\"shipping/free\";i:154;s:17:\"shipping/citylink\";i:155;s:19:\"payment/twocheckout\";i:156;s:16:\"payment/alertpay\";i:157;s:24:\"payment/authorizenet_aim\";i:158;s:21:\"payment/bank_transfer\";i:159;s:14:\"payment/cheque\";i:160;s:14:\"payment/liqpay\";i:161;s:20:\"payment/moneybookers\";i:162;s:14:\"payment/nochex\";i:163;s:15:\"payment/paymate\";i:164;s:16:\"payment/paypoint\";i:165;s:26:\"payment/perpetual_payments\";i:166;s:26:\"payment/perpetual_payments\";i:167;s:26:\"payment/perpetual_payments\";i:168;s:26:\"payment/perpetual_payments\";i:169;s:26:\"payment/perpetual_payments\";i:170;s:26:\"payment/perpetual_payments\";i:171;s:26:\"payment/perpetual_payments\";i:172;s:14:\"payment/pp_pro\";i:173;s:17:\"payment/pp_pro_uk\";i:174;s:19:\"payment/pp_standard\";i:175;s:15:\"payment/sagepay\";i:176;s:22:\"payment/sagepay_direct\";i:177;s:18:\"payment/sagepay_us\";i:178;s:28:\"payment/web_payment_software\";i:179;s:16:\"payment/worldpay\";i:180;s:16:\"payment/alertpay\";i:181;s:24:\"payment/authorizenet_aim\";i:182;s:16:\"feed/google_base\";i:183;s:14:\"total/handling\";i:184;s:15:\"shipping/weight\";i:185;s:15:\"shipping/weight\";i:186;s:16:\"module/supermenu\";i:187;s:13:\"module/sakura\";}}'),
(2, 'Demonstration', '');

DROP TABLE IF EXISTS `sc_voucher`;
CREATE TABLE `sc_voucher` (
...
DROP TABLE IF EXISTS `sc_voucher_history`;
CREATE TABLE `sc_voucher_history` (
...
DROP TABLE IF EXISTS `sc_voucher_theme`;
CREATE TABLE `sc_voucher_theme` (
...
DROP TABLE IF EXISTS `sc_voucher_theme_description`;
CREATE TABLE `sc_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `sc_weight_class`;
CREATE TABLE `sc_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `sc_weight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(3, 2.20460000),
(4, 35.27400000);

DROP TABLE IF EXISTS `sc_weight_class_description`;
CREATE TABLE `sc_weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `sc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(3, 1, 'Pound ', 'lb'),
(4, 1, 'Ounce', 'oz');
...
INSERT INTO `sc_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
DROP TABLE IF EXISTS `sc_zone_to_geo_zone`;
CREATE TABLE `sc_zone_to_geo_zone` (
